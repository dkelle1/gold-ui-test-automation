...
import { allUsers } from '../users/userCatalog.ts';
...
/** Generates random credentials for negative login scenarios, guaranteed not to collide with a real userCatalog account. */
